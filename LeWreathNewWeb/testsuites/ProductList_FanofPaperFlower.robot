...
ตรวจสอบการใช้งานตัวกรอง ช่วงราคา 0-2,000 พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง ช่วงราคา 2,001-3,000 พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง ช่วงราคา 3,001-4,000 พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง ช่วงราคา 4,001-6,000 พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง ช่วงราคา 6,001-8,000 พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง สีแดง พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง สีขาว พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง สีชมพู พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง สีส้ม พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง สีเหลือง พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง สีฟ้า พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง สีม่วง พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง สีเขียว พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง สีน้ำเงิน พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง หลากสี พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง Size S พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง Size M พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง Size L พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง Size XL พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง Size filter_size_XXL พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง พัดลม 16 นิ้ว พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง พัดลม 18 นิ้ว พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง สินค้าแนะนำ พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง สินค้าลดราคา พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
...
ตรวจสอบการใช้งานตัวกรอง สินค้าขายดี พวงหรีดพัดลมดอกไม้ประดิษฐ์
    Open Website
    Click Element    ${Menu_productlist}
    Sleep    2
    Click Element    ${List_Right}
